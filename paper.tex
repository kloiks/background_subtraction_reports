...
\begin{table}[t]
\caption{Experimental datasets used in the analysis. Images lacking clearly defined diffraction features were excluded. A subset was used for experiments. {\color{red} TODO: Check detectors with Prof. Irving. TODO: add data type!!}}
\label{tab:datasets}
\centering
\small
\setlength{\tabcolsep}{4pt}
