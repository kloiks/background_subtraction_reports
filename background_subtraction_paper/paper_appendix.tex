...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{figs/Fig12_appendix_individual_metrics.png}
...
\includegraphics[height=0.9\textheight]{figs/Fig13_appendix_visual_no_eq.png}
