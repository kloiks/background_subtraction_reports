...
\Author{Irina Klein $^{1}$\orcidA{0009-0006-3713-2834}, Gady Agam $^{1}$\orcidB{0000-0001-7805-1527} and Thomas Irving $^{2,}$\orcidC{0000-0003-4848-3323}*}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% optional
\supplementary{The following supporting information can be downloaded at \linksupplementary{s1}. Code for the optimization framework and the evaluation metrics is available at \url{https://github.com/musclex/musclex}.}
...
\dataavailability{A part of the original data presented in the study are openly available in [repository name] at [link], reference number [reference number]. The remaining data presented in this study are available on request from the corresponding author. The source code for the optimization framework and the evaluation metrics is available at \url{https://github.com/username/repo}.} 
...
% Reference 3
\bibitem{NederKorsunskiy2018}
Neder, R.B.; Korsunskiy, V.I. \textit{Two-Dimensional X-ray Diffraction}; Wiley: Hoboken, NJ, USA, 2018.
% Reference 4
...
Lee, X.; Jiratrakanvong, J.; Nikseresht, G.; Lee, X.; Irving, T.C. MuscleX, Version 1.14.12, 2019. Available online: https://doi.org/10.5281/zenodo.3360909 (accessed on Day Month Year).
% Reference 6
\bibitem{rajkumar2007fibrefix}
Rajkumar, G.; Al-Khayat, H.A.; Eakins, F.; Knupp, C.; Squire, J.M. The CCP13 FibreFix Program Suite: Semi-Automated Analysis of Diffraction Patterns from Non-Crystalline Materials. {\em J. Appl. Crystallogr.} {\bf 2007}, {\em 40}, 178--184.
% Reference 7
\bibitem{HeEtAl2007}
He, H.; Knott, R.; Pople, J.; Evans, G.; Nuttall, J.; Cookson, D.; Kirian, R. The CCP13 FibreFix Program Suite: Semi-Automated Analysis of Diffraction Patterns from Non-Crystalline Materials. {\em J. Appl. Crystallogr.} {\bf 2007}, {\em 40}, 178--184.
% Reference 8
\bibitem{IvanovaMakowski1998}
Ivanova, M.I.; Makowski, L. Iterative Low-Pass Filtering for Estimation of the Background in Fiber Diffraction Patterns. {\em J. Appl. Crystallogr.} {\bf 1998}, {\em 31}, 255--262.
% Reference 9
...
Pu, G.; Zheng, X.; Jiang, J. Polar Coordinate-Based Background Removal Algorithm for 2D X-ray Scattering Data. {\em Rev. Sci. Instrum.} {\bf 2024}, {\em 95}, 125109.
% Reference 11
...
Sternberg, S.R. Biomedical Image Processing. {\em IEEE Comput.} {\bf 1983}, {\em 16}, 22--34.
% Reference 14
...
Jiratrakanvong, J.; Linari, M.; Piazzesi, G.; Reconditi, M.; Caremani, M.; Narayanan, T.; Irving, T.C. MuscleX: Data Analysis Software for Fiber Diffraction Patterns from Muscle. {\em J. Synchrotron Radiat.} {\bf 2024}, {\em 31}, 1401--1408.
% Reference 18
