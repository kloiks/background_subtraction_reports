...
\begin{figure}[h]
\centering
\includegraphics[width=0.95\linewidth]{figs/Fig8_consistency_bgsum.png}
...
Figure~\ref{fig:visual_no_eq} illustrates representative examples corresponding to low-loss background subtraction outcomes for images from 3 different datasets. In the low-loss examples, diffuse background is effectively removed while diffraction features are preserved and the residual baseline remains smooth. Supplementaty materials provide examples of background subtraction outcomes for different methods applied to the same pattern, allowing to appreciate the differences in methods and performance. In the high-loss examples, the methods exhibit either incomplete background removal, with elevated residual intensity between layer lines or excessive background removal. These visual differences correspond to the quantitative loss values, indicating that the evaluation metrics reflect perceptually meaningful aspects of background subtraction quality.

\begin{figure}[h]
\centering
\includegraphics[width=0.95\linewidth]{figs/Fig9_visual_no_eq_Jani_21.png}
\hspace{0.01\linewidth}
\includegraphics[width=0.95\linewidth]{figs/Fig9_visual_no_eq_MPLL_20.png}
\hspace{0.01\linewidth}
\includegraphics[width=0.95\linewidth]{figs/Fig9_visual_no_eq_sg_Granzier_21.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.95\linewidth]{figs/Fig11_visual_eq_Weikang_4_v2.png}
\hspace{0.01\linewidth}
\includegraphics[width=0.95\linewidth]{figs/Fig11_visual_eq_Jani_21_v2.png}
\hspace{0.01\linewidth}
\includegraphics[width=0.95\linewidth]{figs/Fig11_visual_eq_MPLL_2.png}
\hspace{0.01\linewidth}
\includegraphics[width=0.95\linewidth]{figs/Fig11_visual_eq_Granzier_4_v2.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{figs/Fig4_ch_example_Jani_1_zoomed.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.95\linewidth]{figs/Fig6_visual_eq_Weikang_4_half.png}
\hspace{0.01\linewidth}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.76\textwidth]{figs/Fig12_appendix_individual_metrics.png}
